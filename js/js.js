let question_arr = ["Про кого йдеться у цих рядках І.Багряного: …йому самому стало себе шкода, шкода того безжурного, молодого веселого обличчя, що колись зводило дівчат з розуму… З води дивилось суворе, металеве обличчя. Ще молоде, але… І ті прямовисні зморшки межи бровами, і крилаті брови, заломлені уперто… Великі очі горіли немов у божевільного?","Уривок 'Лише в один кінець сліди. / А сурми сурмлятьвойовничо.' суголосний з подіями твору", "Словами «Убрав єси нас у шори, як сам схотів! Коли взявся брехати по-собачи, то й пропадеш, як собака!» звертається", "Найважливіші етапи визвольних змагань українського народу осмислено в поезії", "Образ весни, яка «лине вся в прозорих шатах, у серпанках і блаватах», створив"]
let a1_arr = ["Денис Сірко","«Чорна рада»","батько Пугач до Івана Брюховецького","«Уривок з поеми»","Івана Котляревського"]
let a2_arr = ["Григорій Многогрішний","«Слово про похід Ігорів»","Захар Беркут до Тугара Вовка","«Господи, гніву пречистого…»","Микола Вороний"]
let a3_arr = ["майор Медвин","«Захар Беркут»","дід Улас до Чіпки Варениченка","«Балада про соняшник»","Панаса Мирного"]
let a4_arr = ["старий Мороз","«Тіні забутих предків»","отаман Гук до Мартина Пушкаря","«Два кольори»","Івана Франка"]
let answer_arr = ["Григорій Многогрішний","«Слово про похід Ігорів»","батько Пугач до Івана Брюховецького","«Уривок з поеми»","Микола Вороний"]
